...
class App extends Component {
  ...
  getRentedMovies =()=>{
    return this.state.movies.filter(movie=>movie["isRented"]==true)
  ...
  getUnrentedMovies =() =>{
    return this.state.movies.filter(movie=>movie["isRented"]==false)
  }
  render() {
    ...
    <Router>
      <div className='App'>
        ...
        <Route path="/catalog" exact render={() => <Catalog rentedMovies={this.getRentedMovies()} unrentedMovies={this.getUnrentedMovies()} rentAMovie={this.rentAMovie} unrentAMovie={this.unrentAMovie}/>} />  
      </div>
    </Router>
    );
    }
